...
from ..models.product import ProductCategory, Product, ProductImage, ProductFavorite
...
class ProductCategorySerializer(serializers.ModelSerializer):
    ...
    def get_children(self, obj):
        """Get child categories safely"""
        # Use getattr to avoid AttributeError if 'children' doesn't exist
        children_qs = getattr(obj, 'children', None)
        if children_qs:
...
class ProductCreateUpdateSerializer(serializers.ModelSerializer):
    ...
    def validate_category(self, value):
        ...
        from core.models.product import ProductCategory  # Import here to avoid circular imports
        try:
