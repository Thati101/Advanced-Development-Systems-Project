...
class ProductSearchView(mixins.ListModelMixin, viewsets.GenericViewSet):
    """
    Advanced product search functionality.
    """
    permission_classes = [IsAuthenticatedOrReadOnly]
    serializer_class = ProductListSerializer  # Serializer for product list
    ...
    def get_queryset(self):
        ...
        valid_orderings = ['created_at', '-created_at', 'price', '-price', 'title', '-title', 'view_count', '-view_count']
